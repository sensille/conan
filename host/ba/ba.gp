...
set term png size 1200,400
set output "ba/a.png"
plot "vajcs.data" using 1:3 title "acceleration" with lines lt rgb "red"
set term png size 1200,400
set output "ba/j.png"
plot "vajcs.data" using 1:4 title "jerk" with lines lt rgb "green"
set term png size 1200,400
set output "ba/c.png"
plot "vajcs.data" using 1:5 title "curvature" with lines lt rgb "violet"
set term png size 1200,400
set output "ba/s.png"
plot "vajcs.data" using 1:6 title "sharpness" with lines lt rgb "black"
