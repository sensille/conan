...
set_property -dict {PACKAGE_PIN E6 IOSTANDARD LVCMOS33} [get_ports rx2]
set_property -dict {PACKAGE_PIN J5 IOSTANDARD LVCMOS33} [get_ports tx2]
set_property -dict {PACKAGE_PIN K5 IOSTANDARD LVCMOS33} [get_ports cts2]
...
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {dir[0]} ]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports {step[0]} ]
...
set_property -dict {PACKAGE_PIN M12 IOSTANDARD LVCMOS33} [get_ports {dir[2]} ]
set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports {step[2]} ]
